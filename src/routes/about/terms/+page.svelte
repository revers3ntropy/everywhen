<svelte:head>
    <title>Terms of Service | Everywhen</title>
</svelte:head>
<main>
    <h1>Terms of Service ("Terms")</h1>
    <p class="text-light">Our Terms of Service were last updated on 22nd May 2024.</p>
    ...
    <ul>
        ...
        <li>
            “Terms of Service” (also referred as "Terms") mean these Terms of Service that form the
        ...
        <li>
            “Website” refers to Everywhen, accessible from
            <a href="https://everywhen.me"> everywhen.me </a>
        </li>
        <li>
    ...
    <p>
        ...
        Service is conditioned on Your acceptance of and compliance with these Terms of Service.
        These Terms of Service apply to all visitors, users and others who access or use the
        Service. By accessing or using the Service You agree to be bound by these Terms of Service.
        ...
        use the Service. Your access to and use of the Service is also conditioned on Your
    ...
    <p>
        ...
        unauthorized use of Your account. You accept that without your username and password your
        data cannot be accessed. You may not use as a username the name of another person or entity
        or that is not lawfully available for use, a name or trademark that is subject to any rights
        of another person or entity other than You without appropriate authorization, or a name that
        is otherwise offensive, vulgar or obscene.
    </p>

    <h2> Content </h2>
    <h3> Your Right to Store Content </h3>
    <p>
        Our Service allows You to upload and store Content. You are responsible for the Content that
        You store in the Service, including its legality, reliability, and appropriateness. You
        retain any and all of Your rights to any Content You submit, post or display on or through
        the Service and You are responsible for protecting those rights. You represent and warrant
        that: (i) the Content is Yours (You own it) or You have the right to use it and grant Us the
        rights and license as provided in these Terms, and (ii) the posting of Your Content on or
    ...
    <div>
        <p>
            ...
            using Your account. You may not upload any Content that is unlawful. Examples of such
    ...
    <p>
        ...
        be no loss or corruption of data. Corrupt or invalid backup points may be caused by, without
        limitation, Content that is corrupted prior to being backed up or that changes during the
    ...
    <p>
        ...
        claim that Content on the Service infringes a copyright or other intellectual property
        infringement of any person. If You are a copyright owner, or authorized on behalf of one,
        and You believe that the copyrighted work has been copied in a way that constitutes
        copyright infringement that is taking place through the Service, You must submit Your notice
        in writing to the attention of our copyright agent via email (josephcoppin@gmail.com) and
        include in Your notice a detailed description of the alleged infringement. You may be held
        accountable for damages (including costs and attorneys' fees) for misrepresenting that any
    ...
    <p>
        You can contact our copyright agent via email (josephcoppin@gmail.com). Upon receipt of a
    ...
    <p>
        ...
        USD if You haven't purchased anything through the Service. To the maximum extent permitted
        by applicable law, in no event shall the Company or its suppliers be liable for any special,
        ...
        inability to use the Service, third-party software and/or third-party hardware used with the
        ...
        fails of its essential purpose. Some states do not allow the exclusion of implied warranties
        or limitation of liability for incidental or consequential damages, which means that some of
        the above limitations may not apply. In these states, each party's liability will be limited
    ...
    <p>
        ...
        corrected. Without limiting the foregoing, neither the Company nor any of the company's
        ...
        or other harmful components. Some jurisdictions do not allow the exclusion of certain types
        of warranties or limitations on applicable statutory rights of a consumer, so some or all of
        the above exclusions and limitations may not apply to You. But in such a case the exclusions
    ...
    <p>
        ...
        determined at Our sole discretion. By continuing to access or use Our Service after those
        revisions become effective, You agree to be bound by the revised terms. If You do not agree
        to the new terms, in whole or in part, please stop using the website and the Service.
    </p>

    <h2> Contact Us </h2>
    <p>
        If you have any questions about these Terms of Service, You can contact us by sending us an
        email: josephcoppin@gmail.com
    </p>
</main>

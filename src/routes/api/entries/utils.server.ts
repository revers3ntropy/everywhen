...
export function decryptEntry<T extends Entry | RawEntry>
(entry: T, key: string): T {
    return {
        ...entry,
...
export function decryptEntries<T extends Entry | RawEntry>
(entries: T[], key: string): T[] {

...
export type CursorStyle = 'pointer' | 'default' | 'none' | 'auto'
                          | 'crosshair' | 'move' | 'sw-resize'
                          | 'ns-resize' | 'nesw-resize' | 'nwse-resize'
                          | 'text' | 'wait' | 'help' | 'progress'
                          | 'copy' | 'alias' | 'context-menu' | 'cell'
                          | 'vertical-text' | 'no-drop' | 'not-allowed' | 'zoom-in'
                          | 'zoom-out' | 'grab' | 'grabbing' | 'all-scroll'
                          | 'col-resize' | 'row-resize' | 'n-resize'
                          | 'e-resize' | 's-resize' | 'w-resize'
                          | 'ne-resize' | 'nw-resize' | 'se-resize' | 'ew-resize'